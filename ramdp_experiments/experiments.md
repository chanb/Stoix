...
python ramdp_experiments/jumanji_fixed_budget_sweep.py --systems ff_ppo_reinforce --budget 1,2,3,4,5 --seeds 3 --architectures cnn+transformer --hidden-dim 32 --qkv-dim 256 --mlp-dim 256 --num-layers 2 --num-heads 8 --total-timesteps 3e8 --total-num-envs 256 --envs slidingtile --slidingtile-grid-size 3 --slidingtile-num-random-moves 200 --lr 3e-4 --critic-lr 3e-4 --epochs 4 --num-minibatches 8 --use-input-layer-norm true --use-rmsnorm true --ent-coef 0.01 --clip-eps 0.2 --gamma 0.999 --actor-weight-decay 0.1,0.2 --gae-lambda 0.95 --standardize-advantages true --wandb true --wandb-project slidingtile-icot-${project_name} --output-dir /home/bryanpu1/scratch/logs/ramdp/slidingtile-icot-${project_name} --runs-per-gpu 2 --gpus 0,1,2,3,4,5 --no-skip-existing --yes --use-expectile-value-loss true --expectile 0.1 &

python ramdp_experiments/jumanji_sweep.py --systems ff_ppo_reinforce --max-steps 5 --seeds 3 --architectures cnn+transformer --hidden-dim 32 --qkv-dim 256 --mlp-dim 256 --num-layers 2 --num-heads 8 --total-timesteps 3e8 --total-num-envs 256 --envs slidingtile --slidingtile-grid-size 3 --slidingtile-num-random-moves 200 --lr 3e-4 --critic-lr 3e-4 --epochs 4 --num-minibatches 8 --use-input-layer-norm true --use-rmsnorm true --ent-coef 0.01 --clip-eps 0.2 --gamma 0.999 --actor-weight-decay 0.1,0.2 --gae-lambda 0.95 --standardize-advantages true --wandb true --wandb-project slidingtile-icot-${project_name} --output-dir /home/bryanpu1/scratch/logs/ramdp/slidingtile-icot-${project_name} --runs-per-gpu 2 --gpus 6,7 --no-skip-existing --yes --use-expectile-value-loss true --expectile 0.1 &
