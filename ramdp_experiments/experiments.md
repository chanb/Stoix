...
python ramdp_experiments/jumanji_fixed_budget_sweep.py --systems ff_ppo_reinforce --budget 1,2,3 --seeds 5 --architectures transformer --hidden-dim 8 --qkv-dim 128 --mlp-dim 128 --num-layers 2 --num-heads 8 --total-timesteps 1e8 --envs knapsack --knapsack-num-items 10 --lr 3e-4 --critic-lr 3e-4 --epochs 4 --num-minibatches 8 --use-input-layer-norm true --use-rmsnorm true --ent-coef 0.01 --clip-eps 0.2 --gamma 0.999 --actor-weight-decay 0.1 --gae-lambda 0.95 --standardize-advantages true --wandb true --wandb-project knapsack-icot-${project_name} --output-dir /home/bryanpu1/scratch/logs/ramdp/knapsack-icot-${project_name} --runs-per-gpu 4 --gpus 0,1,2 --no-skip-existing --yes --use-expectile-value-loss true &

python ramdp_experiments/jumanji_fixed_budget_sweep.py --systems ff_ppo_reinforce --budget 4,5 --seeds 5 --architectures transformer --hidden-dim 8 --qkv-dim 128 --mlp-dim 128 --num-layers 2 --num-heads 8 --total-timesteps 1e8 --envs knapsack --knapsack-num-items 10 --lr 3e-4 --critic-lr 3e-4 --epochs 4 --num-minibatches 8 --use-input-layer-norm true --use-rmsnorm true --ent-coef 0.01 --clip-eps 0.2 --gamma 0.999 --actor-weight-decay 0.1 --gae-lambda 0.95 --standardize-advantages true --wandb true --wandb-project knapsack-icot-${project_name} --output-dir /home/bryanpu1/scratch/logs/ramdp/knapsack-icot-${project_name} --runs-per-gpu 4 --gpus 3,4,5 --no-skip-existing --yes --use-expectile-value-loss true &

python ramdp_experiments/jumanji_sweep.py --systems ff_ppo_reinforce --max-steps 5 --seeds 5 --architectures transformer --hidden-dim 8 --qkv-dim 128 --mlp-dim 128 --num-layers 2 --num-heads 8 --total-timesteps 1e8 --envs knapsack --knapsack-num-items 10 --lr 3e-4 --critic-lr 3e-4 --epochs 4 --num-minibatches 8 --use-input-layer-norm true --use-rmsnorm true --ent-coef 0.01 --clip-eps 0.2 --gamma 0.999 --actor-weight-decay 0.1 --gae-lambda 0.95 --standardize-advantages true --wandb true --wandb-project knapsack-icot-${project_name} --output-dir /home/bryanpu1/scratch/logs/ramdp/knapsack-icot-${project_name} --runs-per-gpu 4 --gpus 6,7 --no-skip-existing --yes --use-expectile-value-loss true &
