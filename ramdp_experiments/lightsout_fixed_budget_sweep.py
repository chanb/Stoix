...
Usage:
  ...
  python ramdp_experiments/lightsout_fixed_budget_sweep.py --systems ff_ppo_reinforce --architectures mlp \\
  ...
  python ramdp_experiments/lightsout_fixed_budget_sweep.py --systems ff_ppo_explicit_reinforce \\
...
class Job:
    ...
    def group_tag_parts(self) -> List[str]:
        """The group tag broken into semantic chunks - env, algo/arch, budget, gamma, network
...
def build_grid(args: argparse.Namespace) -> List[Job]:
    ...
    # recompute_advantages, critic_before_actor) combos: swept as a
    # full cross product.
    ppo_combos = list(
        itertools.product(
            args.epochs,
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        "transformer_explicit_cot_merged}. iru_unshared "
    ...
    parser.add_argument(
        ...
        "ff_ppo.py's own systems and ff_ppo_explicit_*, unlike --latent-kl-coef above).",
    )
    parser.add_argument(
        "--dpo-alpha",
        default="2.0",
    ...
    parser.add_argument(
        ...
        "{mlp, transformer, gru, iru, transformer_explicit_cot_merged}.",
    )
    parser.add_argument(
        "--num-layers",
        default="1",
    ...
    parser.add_argument(
        ...
        "{transformer, transformer_explicit_cot_merged} (TransformerChainOfThoughtTorso/"
    ...
    parser.add_argument(
        ...
        "architecture in {transformer, transformer_explicit_cot_merged}; ignored "
    ...
    parser.add_argument(
        ...
        "transformer_explicit_cot_merged (unlike --num-heads/--mlp-dim, NOT swept for plain "
    ...
    parser.add_argument(
        ...
        "to architecture in {transformer, transformer_explicit_cot_merged} (every other architecture "
    ...
    print(
        ...
        f"(transformer/transformer_explicit_cot_merged only)"
    )
    ...
    print(
        ...
        "(transformer/transformer_explicit_cot_merged only)"
    )
    print(
