...
# Generic single-command runner for lightsout-icot jobs.
...
#   sbatch --export=ALL,CMD_B64="${CMD_B64}" --job-name=<name> lightsout-icot-run.sh
# Submitted by submit_lightsout-icot.sh, one job per (seed, line) combination.
