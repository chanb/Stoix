...
python ramdp_experiments/lightsout_fixed_budget_sweep.py --systems ff_ppo_reinforce --budget 1,2,3 --seeds 10 --architectures transformer --hidden-dim 128 --mlp-dim 512 --num-layers 2 --num-heads 8 --total-timesteps 3e8 --grid-sizes 5x4 --episode-length 10 --lr 3e-4 --critic-lr 3e-4 --epochs 4 --num-minibatches 8 --use-input-layer-norm true --clip-value-loss true --ent-coef 0.01 --clip-eps 0.2 --gamma 0.99 --actor-weight-decay 0.1 --critic-weight-decay 0.01 --gae-lambda 0.95 --standardize-advantages true --wandb true --wandb-project lightsout-icot-${project_name} --output-dir /home/chanb/scratch/logs/ramdp/lightsout-icot-${project_name} --runs-per-gpu 3 --gpus 0,1 --server vulcan --yes

# python ramdp_experiments/lightsout_fixed_budget_sweep.py --systems ff_ppo_reinforce --budget 4,5 --seeds 10 --architectures transformer --hidden-dim 128 --mlp-dim 512 --num-layers 2 --num-heads 8 --total-timesteps 3e8 --grid-sizes 5x4 --episode-length 10 --lr 3e-4 --critic-lr 3e-4 --epochs 4 --num-minibatches 8 --use-input-layer-norm true --clip-value-loss true --ent-coef 0.01 --clip-eps 0.2 --gamma 0.99 --actor-weight-decay 0.1 --critic-weight-decay 0.01 --gae-lambda 0.95 --standardize-advantages true --wandb true --wandb-project lightsout-icot-${project_name} --output-dir /home/chanb/scratch/logs/ramdp/lightsout-icot-${project_name} --runs-per-gpu 3 --gpus 0,1 --server vulcan --yes

# python ramdp_experiments/lightsout_sweep.py --systems ff_ppo_reinforce --max-steps 5 --seeds 10 --architectures transformer --hidden-dim 128 --mlp-dim 512 --num-layers 2 --num-heads 8 --total-timesteps 3e8 --grid-sizes 5x4 --episode-length 10 --lr 3e-4 --critic-lr 3e-4 --epochs 4 --num-minibatches 8 --use-input-layer-norm true --clip-value-loss true --ent-coef 0.01 --clip-eps 0.2 --gamma 0.99 --actor-weight-decay 0.1 --critic-weight-decay 0.01 --gae-lambda 0.95 --standardize-advantages true --halting-ent-coef 0.01 --halting-temperature 5.0 --wandb true --wandb-project lightsout-icot-${project_name} --output-dir /home/chanb/scratch/logs/ramdp/lightsout-icot-${project_name} --runs-per-gpu 3 --gpus 0,1 --server vulcan --yes
