...
python ramdp_experiments/lightsout_sweep.py --systems ff_ppo_reinforce --max-steps 16 --seeds 10 --architectures iru_unshared --hidden-dim 16 --num-layers 1 --total-timesteps 1e8 --grid-sizes 3x3 --episode-length 5 --eval-episode-length 9 --difficulty-threshold 0.5 --lr 3e-4 --critic-lr 3e-4 --epochs 4 --num-minibatches 8 --use-input-layer-norm true --clip-value-loss false --critic-before-actor false --ent-coef 0.01 --clip-eps 0.2 --gamma 0.99 --actor-weight-decay 0.0 --critic-weight-decay 0.0 --gae-lambda 0.95 --standardize-advantages true --use-rmsnorm true --use-sandwich-norm false --halting-ent-coef 0.0 --halting-temperature 0.5,1 --wandb true --wandb-project lightsout-iru_unshared-${project_name} --output-dir /home/chanb/scratch/logs/ramdp/lightsout-iru_unshared-${project_name} --runs-per-gpu 3 --gpus 0,1 --server vulcan --yes --no-skip-existing --use-expectile-value-loss true
