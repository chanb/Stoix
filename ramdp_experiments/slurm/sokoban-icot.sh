...
python ramdp_experiments/jumanji_fixed_budget_sweep.py --systems ff_ppo_reinforce --budget 1,2,3,4,5 --seeds 5 --runs-per-gpu 1 --architectures cnn+transformer --hidden-dim 128 --qkv-dim 512 --mlp-dim 512 --num-layers 2 --num-heads 16 --total-timesteps 3e9 --clip-value-loss false --lr 3e-4 --critic-lr 3e-4 --envs sokoban --sokoban-generator unfiltered-train --sokoban-eval-generator unfiltered-valid --gpus 0 --rollout-length 20 --total-num-envs 128 --epochs 2 --num-minibatches 4 --ent-coef 0.01 --gamma 0.999 --actor-weight-decay 0.01 --critic-before-actor false --standardize-advantages true --use-input-layer-norm true --use-rmsnorm true --gae-lambda 0.95 --max-grad-norm 5.0 --wandb true --wandb-project sokoban-${project_name} --output-dir ${LOG_DIR}/logs/ramdp/sokoban-icot-${project_name} --yes --no-skip-existing --server slurm --use-expectile-value-loss true --expectile 0.9

python ramdp_experiments/jumanji_sweep.py --systems ff_ppo_reinforce --max-steps 5 --seeds 5 --runs-per-gpu 1 --architectures cnn+transformer --hidden-dim 128 --qkv-dim 512 --mlp-dim 512 --num-layers 2 --num-heads 16 --total-timesteps 3e9 --clip-value-loss false --lr 3e-4 --critic-lr 3e-4 --envs sokoban --sokoban-generator unfiltered-train --sokoban-eval-generator unfiltered-valid --gpus 0 --rollout-length 20 --total-num-envs 128 --epochs 2 --num-minibatches 4 --ent-coef 0.01 --gamma 0.999 --actor-weight-decay 0.01 --critic-before-actor false --standardize-advantages true --use-input-layer-norm true --use-rmsnorm true --gae-lambda 0.95 --max-grad-norm 5.0 --wandb true --wandb-project sokoban-${project_name} --output-dir ${LOG_DIR}/logs/ramdp/sokoban-icot-${project_name} --yes --no-skip-existing --server slurm --use-expectile-value-loss true --expectile 0.9  --halting-lr 0.001 --halting-weight-decay 0 --halting-ent-coef 0.01 --halting-temperature 1.0 --clip-halting-head true  --stop-gradient-halting-input false
